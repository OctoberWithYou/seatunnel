...
/** Test for {@link YStreamEventProcessor}. */
public class YStreamEventProcessorTest {

    @Test
    public void testClassExists() {
        Assertions.assertNotNull(YStreamEventProcessor.class);
    }

    @Test
    public void testClassCanBeInstantiated() {
        YStreamEventProcessor processor = new YStreamEventProcessor();
        Assertions.assertNotNull(processor);
    }

    @Test
    public void testClassHasNoPublicMethods() {
        java.lang.reflect.Method[] methods = YStreamEventProcessor.class.getDeclaredMethods();
