...
/** YashanDB schema change resolver. */
public class YashanSchemaChangeResolver extends AbstractSchemaChangeResolver {

    public YashanSchemaChangeResolver(JdbcSourceConfig jdbcSourceConfig) {
    ...
    protected DdlParser createDdlParser(TablePath tablePath) {
        throw new UnsupportedOperationException(
                "Schema change (DDL) resolution is not yet supported for YashanDB");
    }
